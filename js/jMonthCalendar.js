...
(function($) {
	...
	var defaults = {
			...
			onAbrirEnlace: function(event) { return true; },
	...
	jQuery.J.DrawCalendar = function(dateIn){
		...
		do {
			...
			for (var i=0; i<7; i++) {
				...
				var dateLink = jQuery('<div class="DateLabel"><a href="nuevoservicio.php?cal_fecha='+ _currentDate.getFullYear() + "-" + (_currentDate.getMonth() +1) + "-" + _currentDate.getDate() +'">' + _currentDate.getDate() + '</a></div>').click(function(e) {
