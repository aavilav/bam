...
<html>
    ...
    <body> 
        <h4 class="modal-title">Encuesta Post-Servicio</h4>
        <form action="add_encuesta.php">
          <table class="table" align="center">
              <tr><td>Del servicio brindado Ud. percibio que:</td></tr>
              <tr>
                  <td>         
                          <div><strong>1. El personal conto con un equipamiento moderno y adecuado</strong></div>
                        ...
                        <div><strong>2. El personal tuvo una apariencia presentable</strong></div>
                          ...
                          <div><strong>3. El servicio realizado cumplió con sus expectativas</strong></div>
                          ...
                          <div><strong>4. El servicio se realizó de manera ordenada</strong></div>
                          ...
                          <div><strong>5. El personal escuchó y atendió todas sus necesidades</strong></div>
                          ...
                          <div><strong>6. La atención del personal fue cordial y agradable</strong></div>
                  ...
                  <div><strong>7. El personal cuenta con los implementos de seguridad</strong></div>
                  ...
                  <div><strong>8. El servicio realizado tiene un funcionamiento correcto</strong></div>
                  ...
                  <div><strong>9. El personal está capacitado para el servicio</strong></div>
                  ...
                  <div><strong>10. El servicio se realizó dentro del tiempo establecido</strong></div>
