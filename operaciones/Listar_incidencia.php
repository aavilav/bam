...
<html>
  ...
  <body>
    ...
    $S= new clsNegocio();
    $x=$S->ListarIncidencia();
  ?>
      <div>
      <center><h3>Lista de Incidencias</h3></center>
...
<tr>
    ...
    <td><input type="submit" value="Agregar Detalle" class="btn btn-default"></td>
      ...
      <table align="center" class="table table-hover">
          <tr><th bgcolor="silver">Codigo</th><th bgcolor="silver">Incidencia</th><th bgcolor="silver">Descripcion</th></tr>
          <?php foreach($x as $filas){  ?>
            ...
            <td><?php echo $filas['inc_asunto'] ?></td>
            <td><?php echo $filas['inc_descripcion'] ?></td>
          </tr>
             <?php } } ?>
      </table>
      </div>
