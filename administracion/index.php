...
<link href="../css/bootstrap-responsive.css" rel="stylesheet" media="screen"></link>
    ...
    <script>
      jQuery.fn.cargar = function(url) {
        ...
        function producto(){
            $("#contenido").cargar("producto.php");
        }
        function compras(){
            $("#contenido").cargar("compras.php");
        }
     </script>
</head>
<body>
...
<div class="navbar navbar-inverse">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="index.php">Administracion</a>
...
<div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="#" onclick="producto();">Nuevo Cliente</a></li>
              <li><a href="#" onclick="compras();">Editar Cliente</a></li>
              <li class="divider"></li>
